#ifndef OPERATIONIMAGE_H
#define OPERATIONIMAGE_H
...
class operationimage : public QWidget
{
    Q_OBJECT
public:
    explicit operationimage(QWidget *parent = nullptr);
    /***适应画板****/
    void fitWindow();
    /****设置画板大小*****/
    ...
    void addRoi();
    /***设置操作的方式***/
    void setOperationType(OpeImageEnum);
//    /****检测roi是否超过板子****/
